...
namespace Inventory.InventoryManagement.Controllers
{
    [ApiController]
    ...
    public class InvoicesController : ControllerBase
    {
        ...
        // PUT: api/Invoices
        [HttpGet]
        public async Task<ActionResult<List<InvoiceQueryResponseDto>>> Get()
        {
            var result = await _queryHandler.GetInvoices();
            if (result == null)
            {
                return NotFound();
            }
